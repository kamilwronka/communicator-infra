...
terraform -chdir=./dev-cluster/base plan
terraform -chdir=./dev-cluster/base apply -auto-approve

terraform -chdir=./dev-cluster/istio init
terraform -chdir=./dev-cluster/istio plan
terraform -chdir=./dev-cluster/istio apply -auto-approve

terraform -chdir=./dev-cluster/cert-manager init
terraform -chdir=./dev-cluster/cert-manager plan
terraform -chdir=./dev-cluster/cert-manager apply -auto-approve
